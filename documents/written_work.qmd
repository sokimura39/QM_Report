...
We have used the data for one full year from December 2022 to November 2023, which is the most recent data available from TfL. There is a total of 8,414,631 journeys taken in this period. This dataset will be the scope for our analysis.
...
The average height difference for e-bikes were -0.07 m, significantly ($p < 0.01$) lower than that of e-bikes.

### The impacts of height difference
...
Both conventional cycles and e-bikes have negative average height difference, with e-bikes having less average showing 

### Regression Model 

In order to analyse the impact of the height difference, a multiple regression model is conducted to measure the impacts of this variable.
